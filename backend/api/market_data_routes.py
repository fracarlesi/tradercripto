...
from services.market_data import get_kline_data, get_last_price, get_market_status
    ...
    try:
        ...
        for symbol in symbol_list:
            try:
                ...
                results.append(
                    PriceResponse(
                        symbol=symbol, market=market, price=price, timestamp=current_timestamp
                    )
                )
            except Exception as e:
...
async def get_crypto_kline(symbol: str, market: str = "US", period: str = "1m", count: int = 100):
    """
    ...
    try:
        ...
        return KlineResponse(
            symbol=symbol, market=market, period=period, count=len(kline_items), data=kline_items
        )
    except HTTPException:
        raise
    except Exception as e:
...
async def market_data_health():
    ...
    try:
        ...
        return {
            ...
            "test_price": {"symbol": "MSFT.US", "price": test_price},
