...
Run:
    pytest simple_bot/tests/test_whatsapp_service.py -v
"""
...
from simple_bot.services.whatsapp_service import WhatsAppService, DEFAULT_NTFY_SERVER
from simple_bot.services.message_bus import MessageBus, Message, Topic
