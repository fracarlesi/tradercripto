...
class TestServiceConfigs:
    ...
    def test_kill_switch_config(self):
        ...
        from crypto_bot.services import KillSwitchConfig
    ...
    def test_llm_veto_config(self):
        ...
        from crypto_bot.services import LLMVetoConfig
...
class TestKillSwitch:
    ...
    def test_import(self):
        """Test service can be imported."""
        from crypto_bot.services import KillSwitchService, create_kill_switch
        assert KillSwitchService is not None
        assert create_kill_switch is not None

    def test_initial_state(self):
        """Test kill switch starts in OK state."""
        from crypto_bot.services import KillSwitchService
...
class TestLLMVeto:
    ...
    def test_import(self):
        """Test service can be imported."""
        from crypto_bot.services import LLMVetoService, create_llm_veto
    ...
    def test_fallback_decision(self, valid_setup):
        ...
        from crypto_bot.services.llm_veto import LLMVetoService
...
class TestRegimeGate:
    ...
    def _make_bot(self) -> "ConservativeBot":
        ...
        from crypto_bot.main import ConservativeBot, ConservativeConfig
